...
NKRdata <- read.table('C:/Registre/nkr/data/NKR2010_2015.csv', sep=';', header=T, encoding = 'UTF-8')
...
grVar <- 'BoRHF'  #ShNavn, Fylke, BoHF, BoRHF
...
NKRUtvalg <- RyggUtvalg(RegData=NKRdata, datoFra=datoFra, datoTil=datoTil, minald=minald, maxald=maxald, 
