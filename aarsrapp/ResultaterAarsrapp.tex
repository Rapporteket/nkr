...
{\centering \includegraphics[width=.8\textwidth]{./FigurerResAlder-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigBMI-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigUtd-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerUfor-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigTidlOp-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerTabSmRH-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerAntHovedInngrepAvd-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigLiggetid-1} 
...
\begin{figure}[h] 
\centering \includegraphics[width=0.8\textwidth]{FigLiggetidFord.pdf}
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigEffPre-1} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in RyggFigGjsnBox(RegData = RegData, outfile = "{}Osw30SS.pdf"{}, aar = 2010:2015, : object 'TittelVar' not found}}\end{kframe}

{\centering \includegraphics[width=.8\textwidth]{./FigurerFigEff2-1} 
...
\begin{figure}[h] 
      \centerline{\scalebox{0.8}{\includegraphics{Osw20Pro.pdf}}}
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigNytte-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigFornoyd-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigurer1Pro-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerKvalInd1aar-1} 
...
{\centering \includegraphics[width=.8\textwidth]{./FigurerFigurInf-1} 
...
\includegraphics[width=.8\textwidth]{./FigurerFigurdegSfusj-2} 
