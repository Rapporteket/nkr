...
<<NokkelinfoRygg, echo=FALSE, eval=T>>=
...
tabNokkeltallRygg <- cbind(row.names(NokkeltallRygg),NokkeltallRygg)
  ...
  xtable(tabNokkeltallRygg, caption = 'Nøkkeltall')
@
...
BMIFord <- RyggFigAndeler(RegData=RegData1aar, valgtVar='BMI', datoFra=datoFra, datoTil=datoTil, 
                          outfile='Figurer/FigBMI.pdf', enhetsUtvalg = 0,  tittelMed = 1)
...
<<AntHovedInngrepTab,results='asis', echo=FALSE, eval=FALSE>>=	
