...
Figur \ref{fig:Utd} viser  utdanningsnivå og vi ser at det er \Sexpr{AndelHoyUtd} som har høyere utdanning 
...
Andel som har søkt eller planlegger å søke uføretrygd ligger fortsatt stabilt like under 5 \% i \Sexpr{rappAar}. 
...
Andelen reoperasjoner var \Sexpr{AndelReop2010} \% i 2010 og \Sexpr{AndelReopSisteAar} \% i \Sexpr{rappAar}.
...
operasjonstidspunkt av de som er registrert i NKR \kommentar{var uendret fra 2011 til \Sexpr{rappAar} (47\%)}. 
...
Informasjonen er hentet fra legeskjema.
Figur \ref{fig:Liggedogn} viser liggedøgnsfordeling for alle pasienter operert i \Sexpr{rappAar}. Figur \ref{fig:LiggedognTid} viser gjennomsnittlig antall liggedøgn per år.  
...
operasjon for prolapspasienter operert i \Sexpr{rappAar-1}. Dette betyr at funksjonssvikten ble redusert 
...
DuraPro <- RyggFigAndelerGrVar(RegData=RegData1aar, valgtVar='PeropKompDura', aar=(rappAar-1):rappAar, Ngrense = 20,
                               opKat = 1, tidlOp = 4, hovedkat = 1, outfile='Figurer/FigDuraPro.pdf', tittel=0)
DuraSS <- RyggFigAndelerGrVar(RegData=RegData1aar, valgtVar='PeropKompDura', aar=(rappAar-1):rappAar, Ngrense = 20,
...
N1aar <- dim(NakkeData1aar)[1]
AlderGjsn <- sprintf('%.0f' ,mean(NakkeData1aar$Alder))
Kvinner <- sprintf('%.0f' , (N1aar-sum(NakkeData1aar$ErMann))/N1aar*100)
...
dum <- NakkeFigAndelerGrVar(RegData=NakkeData, valgtVar='NRSsmerteArmEndr12mnd', datoTil = '2016-12-31', 
                     fremBak = 1, myelopati = 0, outfile='Figurer/NakkeNRSsmerteArmEndr12mndUmFSh.pdf')

dum <- NakkeFigAndelerGrVar(RegData=NakkeData, valgtVar='NDIendr12mnd', datoTil = '2016-12-31', 
                     fremBak = 1, myelopati = 0, outfile='Figurer/NakkeNDIendr12mndUmFSh.pdf')

dum <- NakkeFigAndelerGrVar(RegData=NakkeData, valgtVar='FornoydBeh12mnd', datoTil = '2016-12-31', 
...
dum <- NakkeFigAndelerGrVar(RegData=NakkeData1aar, valgtVar='Komplinfek3mnd', fremBak = 2,
