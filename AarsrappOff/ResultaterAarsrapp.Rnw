...
\Sexpr{datomax}. Siden oppstart i 2007 til og med \Sexpr{rappAar} er det totalt registrert 38612 operasjoner i NKR degenerativ rygg. 
\par
...
Gjennomsnittsalder ved nakkeoperasjon var \Sexpr{AlderGjsnNakke} år i \Sexpr{rappAar} og \Sexpr{Elektivt} \% ble operert med elektiv, planlagt kirurgi. Andel kvinner var  \Sexpr{Kvinner} \%.
Andel som hadde ASA-grad over II var \Sexpr{ASA345} \%. Andelen eldre over 70 år som nakkeopereres har ligget jevnt 
rundt 5 \% frem til og med \Sexpr{rappAar}, men varierer noe mellom sykehus, spesielt mellom offentlige og private, 
...
\caption{\label{fig:NakkeKomplinfek3mndSh} Andel pasienter som rapporterer om sårinfeksjon 3 måneder etter nakkekirurgi (fremre og bakre) i \Sexpr{rappAar}. }
\end{figure}
