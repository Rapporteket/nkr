...
\begin{tabular}{rlllllllll}
 ...
 & 0-19 & 20-29 & 30-39 & 40-49 & 50-59 & 60-69 & 70-79 & 80-89 & 90+ \\ 
  \hline
Andeler & 0.4\% & 4.6\% & 11\% & 16.9\% & 18.9\% & 22.5\% & 20\% & 5.5\% & 0.1\% \\ 
  Antall & 21 & 243 & 578 & 891 & 998 & 1187 & 1056 & 291 & 7 \\ 
   \hline
\end{tabular}
\caption{Aldersfordeling, 2017.} 
\label{tab:Alder}
\end{table}


Gjennomsnittsalderen har økt jevnt fra 53.7 år i 2010 til 57.0 år i 2017. 
...
\begin{figure}[ht]
\scalebox{0.7}{\includegraphics{Figurer/FigUtd.pdf}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in paste0("{}Arbeidsstatus, pasienter operert i "{}, aarsrappAar): object 'aarsrappAar' not found}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in dimnames(x) <- dn: length of 'dimnames' [1] not equal to array extent}}\end{kframe}% latex table generated in R 3.5.0 by xtable 1.8-2 package
% Thu Jun 07 16:51:23 2018
\begin{table}[ht]
\centering
\begin{tabular}{crr}
  \hline
