...
AlderFord <- RyggFigAndeler(RegData=RegData1aar, valgtVar='Alder', datoFra=datoFra1aar, datoTil=datoTil, enhetsUtvalg=0, outfile='Figurer/FigAlderFord.pdf')
...
HovedInngrep <- RyggFigAndeler(RegData=RegData1aar, valgtVar='HovedInngrep', datoFra=datoFra1aar, datoTil=datoTil, 
                               enhetsUtvalg=enhetsUtvalg, outfile='Figurer/HovedInngrep.pdf')
