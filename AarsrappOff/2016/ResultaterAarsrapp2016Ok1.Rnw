...
ktr <- 2
ktrtxt <- '12 mnd.'
s1 <- 0.65	#Skaleringsparameter for enkeltfigurer
...
\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{FigAlder70.pdf}}
...
\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{FigBMI.pdf}}
...
\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{FigMorsmal.pdf}}
...
HoyUtdAvd <- RyggFigAndelerGrVar(RegData=RegData1aar, valgtVar='Utd', Ngrense = 10,
                                 outfile='FigHoyUtdAvd.pdf', tittel=0)
...
\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{FigUtd.pdf}}
\caption{\label{fig:Utd} \Sexpr{Utdanning$Tittel}}
\end{figure}

\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{FigHoyUtdAvd.pdf}}
...
UforetrygdPre <- RyggFigAndelerGrVar(RegData=RegData, valgtVar='UforetrygdPre', datoFra='2016-01-01',
                                     outfile='FigUforAvd.pdf', tittel=0)
...
\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{FigUforAvd.pdf}}
...
\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{TidlOp.pdf}}
...
Figur \ref{fig:VarighSmerteUtstrTid} viser utvikling over tid for andel med pasienter med lang symptomvarighet som opereres. 
\begin{figure}[h] 
\center{
\scalebox{\Sexpr{s2}}{\includegraphics{VarighUtstrTidPro.pdf}}
\scalebox{\Sexpr{s2}}{\includegraphics{VarighUtstrTidSS.pdf}}} 
...
%\begin{figure}[ht]
%      \scalebox{\Sexpr{s1}}{\includegraphics{HovedInngrep.pdf}}
...
\begin{figure}[ht]
\scalebox{\Sexpr{s1}}{\includegraphics{FigdegSponFusj.pdf}}
\caption{\label{fig:degSpnFusj} Degenerativ spondylolistese operert med fusjonskirurgi}
\end{figure}
...
dum <- RyggFigGjsnGrVar(RegData=RegData1aar, outfile='LiggetidAvdPro.pdf', #aar=2016
                        valgtVar='Liggedogn', hovedkat = 1, valgtMaal = 'Gjsn', tittel=0)
dum <- RyggFigGjsnGrVar(RegData=RegData1aar, outfile='LiggetidAvdSS.pdf', #aar=2016,
...
\begin{figure}[h] 
\scalebox{\Sexpr{s1}}{\includegraphics{FigLiggetidFord.pdf}}
...
\begin{figure}[h] 
\scalebox{\Sexpr{s1}}{\includegraphics{LiggetidAvdPro.pdf}}
...
\begin{figure}[h] 
\scalebox{\Sexpr{s1}}{\includegraphics{LiggetidAvdSS.pdf}}
...
dum <- RyggFigGjsnGrVar(RegData=RegData, outfile='OswEndrAvdPro.pdf', Ngrense = 20, aar=2014:2015, 
                        valgtVar='OswEndr', hovedkat=1, tidlOp=4, opKat=1, ktr=ktr, tittel=0)
dum <- RyggFigGjsnGrVar(RegData=RegData, outfile='OswEndrAvdSS.pdf', Ngrense = 20, aar=2014:2015, 
                        valgtVar='OswEndr', hovedkat=8, tidlOp=4, ktr=ktr, tittel=0)


dum <- RyggFigAndelTid(RegData=RegData, outfile='Osw20TidPro.pdf', 
                       aar=2010:2015, valgtVar='OswEndr20', hovedkat=1, ktr=ktr, tittel=0)
dum <- RyggFigAndelTid(RegData=RegData, outfile='Osw30TidSS.pdf', 
                       aar=2010:2015, valgtVar='OswEndr30pst', hovedkat=8, ktr=ktr, tittel=0)

dum <- RyggFigGjsnBox(RegData=RegData, outfile='OswEndrTidPro.pdf', 
                      aar=2010:2015, valgtVar='OswEndr', hovedkat=1, ktr=ktr, tittel=0)

dum <- RyggFigGjsnBox(RegData=RegData, outfile='OswEndrTidSS.pdf', 
                      aar=2010:2015, valgtVar='OswEndr', hovedkat=8, ktr=ktr, tittel=0)
...
\begin{figure}[h] 
\scalebox{\Sexpr{s1}}{\includegraphics{OswEndrAvdPro.pdf}}
\caption{Gjennomsnittlig endring av ODI per avdeling for prolaps}
\label{fig:OswEndrAvdPro}
\end{figure}

\begin{figure}[h] 
\scalebox{\Sexpr{s1}}{\includegraphics{OswEndrAvdSS.pdf}}
