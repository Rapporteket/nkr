...
#AntHovedInngrepLand <- AntSoyler(RegData=RegData, libkat=libkat, outfile='figurer/HinngrLand.pdf', 
...
%  \caption{\Sexpr{paste('Figuren til venstre viser fordeling av Oswestry før og ', ktrtxt, ' etter operasjon, mens %figuren til høyre viser gjennomsnittlig endring i Oswestry, ', ktrtxt,  ' etter operasjon.', sep='')}}
  \caption{\Sexpr{paste0('Figuren til viser gjennomsnittlig endring i Oswestry, ', ktrtxt,  ' etter operasjon og andel pasienter med klinisk signifikant forbedring (30%) av Oswestry-skår.')}}
  \label{fig:OswEndr}
\end{figure}
