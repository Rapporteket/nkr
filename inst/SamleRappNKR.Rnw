...
RegData$ShNavn <-  iconv(RegData$ShNavn, from = '', to = 'UTF-8')
	#Formatering 
...
Utd <- RyggFigAndeler(RegData=RegData, valgtVar='Utd', datoFra=datoFra, datoTil=datoTil, 
			reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='FigUtd.pdf', tittel=0)
...
operert i samme nivå, \Sexpr{TidlOpHoved[2]}\% 
%(\Sexpr{TidlOpRL[2]}\%) 
operert i annet nivå og \Sexpr{TidlOpHoved[3]}\% 
%(\Sexpr{TidlOpRL[3]}\%) 
...
BMIFord <- RyggFigAndeler(RegData=RegData, valgtVar='BMI', datoFra=datoFra, datoTil=datoTil, 
			reshID=reshID, outfile='FigBMI.pdf', enhetsUtvalg = 0,  tittel=0)
@
...
%Figur \ref{fig:VarighSmerteRHF} viser andelen som har hatt smerter i mer enn ett år før operasjonen
...
AnnetAvd <- round(length(which(RegDataHoved$RfAnnet != 'NA'))*100/NHoved, 1)
AnnetRL <- round(length(which(RegDataSml$RfAnnet != 'NA'))*100/NSml, 1)
...
%				'Andeler' = paste0(round(AntOpMndLand$Antall/Ntot*100, 1),'\%''))
%xtable(AntOpMnd, caption=AntOpMndLand$Tittel[1], label="tab:AntOpMnd", digits=1, align=c('l',rep('c',12)))
...
xtable(HovedInngrepTab, align=c('l','r','r'), caption=HovedInngrep$Tittel[1], label="tab:AntHovedInngrep", digits=1)
}
...
LiggetidFord <- RyggFigAndeler(RegData=RegData, valgtVar='Liggedogn', datoFra=datoFra, datoTil=datoTil, 
			reshID=reshID, enhetsUtvalg=enhetsUtvalg, outfile='FigLiggetidFord.pdf', tittel=0)
...
LiggetidBox <- RyggFigGjsnTid(RegData=RegData,  outfile='LiggetidBox.pdf', 
		valgtVar='Liggedogn', ktr=ktr, tittel=0, valgtMaal='', enhetsUtvalg=enhetsUtvalg, reshID=reshID)
@
...
dum <- RyggFigGjsnBox(RegData=RegData,  outfile='OswEndr.pdf', 
		valgtVar='OswEndr', ktr=ktr, tittel=0, valgtMaal='', enhetsUtvalg=enhetsUtvalg, reshID=reshID)
...
#dum <- RyggFigAndelerGrVar(RegData=RegData, valgtVar='OswEndr30pst', datoFra=datoFra, datoTil=datoTil, ktr = ktr,
 #                           minald=minald, maxald=maxald, erMann=erMann, hovedkat=hovedkat, preprosess=0,
...
%  \scalebox{\Sexpr{s2}}{\includegraphics{\Sexpr{ 'OswestryPP.pdf'}}}
  \scalebox{\Sexpr{s1}}{\includegraphics{\Sexpr{ 'OswEndr.pdf'}}}
...
dum <- RyggFigGjsnBox(RegData=RegData,  outfile='EQ5DEndrTid1.pdf', 
		valgtVar='EQ5DEndr', ktr=1, tittel=0, valgtMaal='', enhetsUtvalg=enhetsUtvalg, reshID=reshID)
dum <- RyggFigGjsnBox(RegData=RegData,  outfile='EQ5DEndrTid2.pdf', 
		valgtVar='EQ5DEndrPre', ktr=2, tittel=0, valgtMaal='', enhetsUtvalg=enhetsUtvalg, reshID=reshID)
...
dum <- RyggFigGjsnBox(RegData=RegData,  outfile='SmRyggEndrPre.pdf', 
		valgtVar='SmRyggEndrPre', ktr=ktr, tittel=0, valgtMaal='', enhetsUtvalg=enhetsUtvalg, reshID=reshID)
dum <- RyggFigGjsnBox(RegData=RegData,  outfile='SmRyggEndrTid.pdf', 
		valgtVar='SmRyggEndr', ktr=ktr, tittel=0, valgtMaal='', enhetsUtvalg=enhetsUtvalg, reshID=reshID)
@
...
dum <- RyggFigGjsnBox(RegData=RegData,  outfile='SmBeinEndrPre.pdf', 
		valgtVar='SmBeinEndrPre', ktr=ktr, tittel=0, valgtMaal='', enhetsUtvalg=0, reshID=reshID)
dum <- RyggFigGjsnBox(RegData=RegData,  outfile='SmBeinEndrTid.pdf', 
		valgtVar='SmBeinEndr', ktr=ktr, tittel=0, valgtMaal='', enhetsUtvalg=0, reshID=reshID)
@
