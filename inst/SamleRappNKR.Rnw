...
figKrymp1 <- 0.8
s2 <- 0.65	#Skaleringsparameter for "dobbeltfigurer"
...
print(xtable(HovedInngrepTab, align=c('l','r','r')), caption=HovedInngrep$Tittel[1], label="tab:AntHovedInngrep", digits=1))
}
